export default function Testimonial() {
  return (
    <section className="mx-auto max-w-6xl px-4 py-16 md:py-24">
      {/* Heading */}
      <h2 className="mb-8 text-center text-2xl sm:text-4xl lg:text-4xl font-semibold font-heading md:text-5xl">
        Kind words from our{' '}
        <span className="text-[#0095FF] text-2xl sm:text-4xl lg:text-4xl font-semibold font-heading">Customer</span>
      </h2>
